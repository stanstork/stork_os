use super::{boot::Fat32BootSector, calculate_checksum, create_short_filename};
use crate::{
    fs::{
        fat::{
            dir_entry::DirectoryEntry,
            long_entry::{create_lfn_entries, LongDirectoryEntry},
        },
        vfs::entry::VfsDirectoryEntry,
    },
    memory, print, println,
    storage::ahci::device::AhciDevice,
};
use alloc::vec::Vec;
