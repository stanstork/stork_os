    ...
    pub const fn default() -> Display {
        Display {
            ...
            font: &PSF1Font {
                ...
                psf1_header: crate::boot::PSF1Header {
                    magic: [0; 2],
                    mode: 0,
                    char_size: 0,
                },
...
#[macro_export]
macro_rules! print {
    ($($arg:tt)*) => {$crate::devices::video::display::print(format_args!($($arg)*))};
}
...
macro_rules! cls {
    () => {
        $crate::devices::video::display::clear_screen();
    };
}
